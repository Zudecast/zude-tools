...
const PATH_SETTING: PackedScene = preload("res://Scenes/Settings/zude_tools_path_setting.tscn")
...
func _ready() -> void:
	...
	close_settings_button.pressed.connect(toggle_interface)
...
func _exit_tree() -> void:
	...
	close_settings_button.pressed.disconnect(toggle_interface)
