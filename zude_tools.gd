...
## Read config and connect all signals.
func _ready() -> void:
	read_directory()
	...
	preview_size_slider.value_changed.connect(resize_previews)
...
func _exit_tree():
	...
	preview_size_slider.value_changed.disconnect(resize_previews)
